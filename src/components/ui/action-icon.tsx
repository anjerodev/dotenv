...
const actionIconVariants = cva(
  'transition-all active:scale-90 hover:-translate-y-0.5 flex items-center justify-center rounded-md outline-none ring-ring disabled:opacity-80 disabled:pointer-events-none ring-0 focus-visible:ring-2 focus-visible:ring-offset-0 ring-offset-background',
  {
    variants: {
      variant: {
